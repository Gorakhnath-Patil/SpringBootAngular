...
public class Policy {
	...
	public String toString() {
		return "Policy [id=" + id + ", name=" + name + ", category=" + category + ", duration=" + duration
				+ ", initialDeposit=" + initialDeposit + ", termPerYear=" + termPerYear 
				+ ", rateOfInterest=" + rateOfInterest + ", status=" + status + ", buyCount=" + buyCount + ", slab1="
				+ slab1 + ", slab2=" + slab2 + ", slab3=" + slab3 + ", slab4=" + slab4 + ", vendor=" + vendor + "]";
	}
